...
void MainWindow::on_actionNew_triggered()
{
    ...
    w->setWindowTitle(tr("图层%1").arg(ui->mdiArea->subWindowList().size()));
    w->show();
...
void MainWindow::on_actionactionLine_triggered()
{
...
void MainWindow::setMode(Mode m)
{
    ...
    switch(m)
    {
    case LINE: ui->actionLine_2->setChecked(true); break;
